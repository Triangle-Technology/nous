...
#[cfg(feature = "candle")]
use nous::cognition::hs_arousal::arousal_from_hs;
#[cfg(feature = "candle")]
use nous::inference::cognitive_model::CognitiveModel;
#[cfg(feature = "candle")]
use nous::inference::mamba::{compute_hs_stats, CognitiveMambaModel, HfTokenizer, MambaConfig};
#[cfg(feature = "candle")]
...
fn compute_avg_cross_entropy(
    ...
    tokens: &[u32],
    delta_mod: Option<&nous::types::intervention::DeltaModulation>,
) -> f64 {
    if tokens.len() < 2 {
        return 0.0;
    }
...
fn compute_avg_cross_entropy_hs(
    ...
    use nous::cognition::delta_modulation::compute_layer_targets;
    use nous::cognition::locus_coeruleus::LocusCoeruleus;
